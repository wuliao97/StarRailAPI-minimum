...
use crate::client::routes::{GameRoute, GameTrait, InternationalRoute, InternationalTrait, Route, RouteTrait};
use crate::util::types::{Region,
 Game::{self,
 GENSHIN,
 HONKAI,
 STARRAIL}};
...
pub(crate) static UID_RANGE: Lazy<HashMap<Game,
 HashMap<Region,
 Vec<u8>>>> = Lazy::new(|| {
    let mut map = HashMap::new();
    {
